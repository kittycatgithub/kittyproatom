...
export const categories = [
  {
    text: "Meal Thali & Snack Boxes",
    path: "meal-thali-snack-boxes",
...
export const actualProducts = [
  // Vegetables
  {
   ...
   unit:"/thali",
    ...
    description: ["+ 5% GST + Delivery Charges"],
    minOrder: ["Min Order Qty - 5"],
    createdAt: "2025-03-25T07:17:46.018Z",
    updatedAt: "2025-03-25T07:18:13.103Z",
    inStock: true,
  },
  {
    ...
    menu: [
      ...
      "Dal Tadka / Dal Fry",
      "Jeera Basmati Rice",
      "2 Chapati and 2 Paratha",
      "Sweet Curd / Raita",
      "2 pieces of sweet",
      "Achar, Papad and Curd",
    ],
    description: ["+ 5% GST + Delivery Charges"],
    minOrder: ["Min Order Qty - 5"],
    createdAt: "2025-03-25T07:17:46.018Z",
  ...
  },
  {
    ...
    menu: [
      ...
      "Snack (1 Piece)",
      "Packed Beverage (1 Small)",
      "Dessert (1 Piece)",
      "Tissue paper and Sauce Pouches",
      ],
    description: [
      "+ 5% GST + Delivery Charges",
    ],
    minOrder: ["Min Order Qty - 10"],
    createdAt: "2025-03-25T07:17:46.018Z",
    updatedAt: "2025-03-25T07:18:13.103Z",
    inStock: true,
  },
  ...
  // Catering Section
  {
    ...
    menu:[
      ...
      "Menu 2 ⟶ Aloo Poha, Chana Rassa, Batata Wada, Tea, Coffee and Cookies",
      "Menu 3 ⟶ Misal Pao, Dhokla, Chutney, Tea, Coffee and Cookies",
      "Menu 4 ⟶ Sprouts Usal, Chiwda, Sabudana Khichadi, Dahi Chutney, Tea, Coffee, Cookies",
      "Menu 5 ⟶ Upma, Chutney, Wada Pao, Lasan Chutney, Tea, Coffee and Cookies",
      "Menu 6 ⟶ Veg Sandwich, Mayo Dip. Veg Cutlet, Muffin, Tea, Coffee, Cookies",
  ...
  },
  {
    ...
    name: "Short Menu",
    menu:[
      "Menu 1 ⟶ Chola Bhatura, Dahi Wada, Gulab Jamun and Veg Pulao",
      "Menu 2 ⟶ Pav Bhaji, Tawa Pulao, Boondi Raita and Rasgulla",
      "Menu 3 ⟶ Masala Dosa, Sambar, Chutney, Curd Rice and Ghee ka Sheera",
      "Menu 4 ⟶ Veg Noodles, Veg Manchurian, Veg Fried Rice and Ice-cream",
      "Menu 5 ⟶ Stuffed Paratha, Veg Biryani, Raita and Chamcham",
      "Menu 6 ⟶ Baingan Bharta, Bhakri, Gola Bhaat, Kadhi and Jalebi",
      "Menu 7 ⟶ Paani Poorie, Paapdi Chaat, Ragda Pattis and Shahi Tukada",
