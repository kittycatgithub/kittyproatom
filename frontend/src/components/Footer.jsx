...
const Footer = () => {
  return (
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-4 gap-0 lg:gap-0 max-w-xs mx-auto sm:max-w-2xl md:max-w-3xl lg:max-w-full">
                <div className="col-span-full lg:col-span-1 mb-10 lg:mb-0">
                  <div className='w-fit mx-auto'>
                    ...
                    <p className="py-2 text-md lg:text-md text-gray-700 lg:max-w-xs text-center lg:text-left">Trusted by more than 100 companies & 5 million customers. Follow us on social media.</p>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 93 92" fill="none">
      ...
      <img src="https://www.svgrepo.com/show/205306/youtube.svg" alt="" className='h-10.5'/>
      </a>
      ...
      <a  target='_blank' className="group transition-all duration-500 hover:-translate-y-2">
      <svg width="42" height="42" viewBox="0 0 92 92" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M18.3711 31.587V36.4343L30.4893 45.5229V29.7693L27.0962 27.2245C23.4971 24.5282 18.3711 27.0912 18.3711 31.587Z" fill="#C5221F"/>
                ...
                <div className="mx-auto text-center sm:text-left">
                    <h4 className="text-lg text-gray-900 font-medium mb-3 ">Quick Links</h4>
                ...
                <div className=" text-center sm:text-left">
                    <h4 className="text-lg text-gray-900 font-medium mb-3">Products</h4>
                    <ul className="text-lg lg:text-md  transition-all duration-500">
  ...
  <li className="mb-2 flex flex-row gap-2 justify-center">
    ...
    >
      +91 9975094003
            ...
            {/* <!--Grid--> */}
            <div className="py-7 md:py-1 border-t border-gray-200">
                <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                    ...
                    {/* <span className="text-sm text-gray-500 pt-4 md:pt-0"><a href="https://www.instagram.com/hostcloudrcs" target='_blank'>Designed & Developed By HostCloudRCS</a></span> */}
