...
const services = [
  {
    ...
    link: "./Baron_Packed_Thali_n_Sancks_Box_Menu_March2026.pdf" // replace with actual path
  },
  {
    title: "Outdoor Catering / Delivery",
    ...
    link: "./Baron Catering Menu March2026.pdf" // replace with actual path
  },
  {
    title: "Hospital / Corporate Catering",
    description: "We focus on quality and flavor, and cook health-conscious meals",
    button: "Week's Menu",
    image: "hospital_tray.avif",
    link: "/hospital-and-corporate-food-service" // replace with actual Google Doc link
  },
  {
    title: "Food Processing",
    description: "If you have a food business and want to bring in consistency and ease in your business get in touch with us.",
    button: "Ask Us",
    image: "Processing_Website.avif",
    link: "tel:+91 9822990025" // replace with actual number
  },
];
...
const OurServices = ({ id }) => {
  return (
    <section id={id} className="bg-gray-50 px-4 lg:px-12 py-12 text-gray-800">
      <h2 className="text-3xl text-center text-orange-600 pb-12 font-normal tracking-tight sm:text-5xl md:text-5xl">
        Our Services
      </h2>
  ...
  >
    ...
    <div className="w-full sm:w-1/2 p-4 flex flex-col justify-between text-center sm:text-left">
      ...
      <a
        href={service.link}
        target={service.link.startsWith("http") || service.link.endsWith(".pdf") ? "_blank" : "_self"}
        rel="noopener noreferrer"
        className="bg-orange-600 text-white px-4 py-2 rounded hover:bg-orange-700 w-fit mx-auto sm:mx-0"
      >
        {service.button}
      </a>
    </div>
