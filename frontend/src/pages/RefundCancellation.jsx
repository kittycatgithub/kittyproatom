       ...
       <div className=" w-screen text-gray-900 bg-gray-50 container">
            <div className="px-6  sm:text-center md:mx-auto max-w-7xl lg:col-span-6 lg:flex lg:items-center lg:text-left">
              ...
              <p className=" sm:mt-5 text-lg text-justify">
                ...
                <ul>
                  <li className='list-inside list-disc'>Customers must share photos/videos at the time of delivery.</li>
                  <li className='list-inside list-disc'>After verification, a full refund or replacement will be issued.</li>
                </ul>           
              </p>
              <p className=" sm:mt-5 text-lg text-justify">
                ...
                <ul>
                  <li className='list-inside list-disc'>Proof (photo/video) must be shared within 1 hour of delivery.</li>
                  <li className='list-inside list-disc'>A replacement will be arranged at no extra cost or a refund will be provided.</li>
                </ul>           
              </p>
              <p className=" sm:mt-5 text-lg text-justify">
                ...
                <ul>
                  <li className='list-inside list-disc'>A full refund will be processed immediately.</li>
                </ul>           
              </p>
              <h1 className="text-2xl pt-5 font-semibold">
              ...
              <p className=" sm:mt-5 text-lg text-justify">
                <li className='list-inside list-disc'>The product was not stored properly by the customer after delivery.</li>
                <li className='list-inside list-disc'>Customer changes their mind after delivery.</li>
                <li className='list-inside list-disc'>Complaints raised without evidence or raised after 1 hour of delivery.</li>
                <li className='list-inside list-disc'>Delays caused by factors beyond our control (traffic, weather, unexpected events).</li>
              </p>
              <h1 className="text-2xl pt-5 font-semibold">
                4. Delivery Area
              </h1>
              <p className=" sm:mt-5 text-lg text-justify">
                  <li className='list-inside list-disc'>We deliver only within Nagpur city limits.</li>
                  <li className='list-inside list-disc'>Orders placed outside Nagpur will be cancelled automatically and refunded.</li>
              </p>
              <h1 className="text-2xl pt-5 font-semibold">
