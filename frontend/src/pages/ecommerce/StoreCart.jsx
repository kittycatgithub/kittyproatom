...
const StoreCart = () => {
  ...
  const placeOrder = async () => {
    try {
      ...
      let finalPrice = totalAmount + 52.5;
      ...
      <div className="flex-1 max-w-4xl">
        ...
        {cartArray.map((product, index) => (
          ...
          >
                ...
                <div className="font-normal text-gray-black">
                  ...
                  <div className="flex items-center">
                    ...
                    <input
                      ...
                      // onChange={(e) =>
                      //   updateStoreCartItem(product._id, e.target.value)
                      // }
                      onChange={(e) => {
                        let value = Number(e.target.value);

                        // If empty, zero, negative, or NaN → set to 1
                        if (!value || value < 1) {
                          value = 1;
                        }

                        updateStoreCartItem(product._id, value);
                      }}
                      type="number"
                      min={1}
            ...
            <button
              onClick={() => removeFromStoreCart(product._id)}
          ...
          <div className="relative flex justify-between items-start mt-2">
            {user ? (
              <p className="text-gray-500">
                {selectedAddress
                  ? `${selectedAddress.address}, ${selectedAddress.city}, ${selectedAddress.state}, India`
                  : "No address found"}
              </p>
            ) : (
