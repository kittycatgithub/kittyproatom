...
const NonVeg = () => {
    ...
    {   name:"Starters",
        value: [{name:"Aloo Tikki Kebab", price:'₹350/kg',amount: 350 ,unit: 'kg', img:"https://www.indianhealthyrecipes.com/wp-content/uploads/2021/09/aloo-tikki-recipe.webp"}, 
            {name:"Harabhara Kebab", price:'₹350/kg',amount: 350 ,unit: 'kg', img:"https://cdn.zeptonow.com/production///tr:w-600,ar-100-100,pr-true,f-auto,q-80/web/recipes/hara-bhara-kebab.png"}, 
            {name:"Cheese Corn Balls", price:'₹350/kg',amount: 350 ,unit: 'kg', img:"https://gingerskillet.com/wp-content/uploads/2021/03/CHEESECORNBALLS_F.jpg"}, 
            {name:"Chilly Panner", price:'₹700/kg',amount: 700 ,unit: 'kg', img:"https://spicecravings.com/wp-content/uploads/2022/01/Chilli-Paneer-Featured-2.jpg"}, 
            {name:"Paneer Teriyaki", price:'₹850/kg',amount: 850 ,unit: 'kg', img:"https://hikarimiso.com/wp-content/uploads/2021/11/Teriyaki-Miso-Sauce-Recipe.jpg"}, 
            {name:"Honey Chilli Potato Wegdes", price:'₹700/kg',amount: 700 ,unit: 'kg', img:"https://static.toiimg.com/thumb/52532656.cms?imgsize=498654&width=800&height=800"}, 
            {name:"Crispy Veg", price:'₹500/kg',amount: 500 ,unit: 'kg', img:"https://littlechef.co.in/wp-content/uploads/2017/07/crispy-fried-schezwan-vegetable.jpg"}, 
            {name:"Veg Spring Roll", price:'₹550/kg',amount: 550 ,unit: 'kg', img:"https://d1mxd7n691o8sz.cloudfront.net/static/recipe/recipe/2023-12/Vegetable-Spring-Rolls-2-1-906001560ca545c8bc72baf473f230b4.jpg"}, 
            {name:"Dry Gobi Manchurian", price:'₹450/kg',amount: 450 ,unit: 'kg', img:"https://www.indianhealthyrecipes.com/wp-content/uploads/2022/02/gobi-manchurian-cauliflower-manchurian.jpg"}, 
            {name:"Veg Nuggets", price:'₹450/kg',amount: 450 ,unit: 'kg', img:"https://static.toiimg.com/photo/84291091.cms"}, 
            {name:"Chilly Garlic Potato Pop", price:'₹500/kg',amount: 500 ,unit: 'kg', img:"https://blueappledistributionhub.in/wp-content/uploads/2022/06/2-2.jpg"}, 
            {name:"Veggie Fingers", price:'₹500/kg',amount: 500 ,unit: 'kg', img:"https://chillfillfoods.com/uploads/media/66adf89265c74.webp"}, 
            {name:"Cheese Cracker Bruschetta", price:'₹500/kg',amount: 500 ,unit: 'kg', img:"https://images-tastehub.mdlzapps.cloud/images/ccc6487c-5e6f-4ed8-8a32-b949432df40a.jpg"}, 
            {name:"Paneer Tikka", price:'₹800/kg',amount: 800 ,unit: 'kg', img:"https://sharethespice.com/wp-content/uploads/2024/02/Paneer-Tikka-Featured.jpg"}, 
            {name:"Paneer Malai Tikka", price:'₹800/kg',amount: 800 ,unit: 'kg', img:"https://derafarms.com/cdn/shop/files/deraproducts-2024-06-13T170506.729_grande.png?v=1718278525"}]
    },  
    {   name:"Rotis",
    ...
    {       name:"Desserts",
        value: [
          {name:"Gulab Jamun", price:'₹18/pc',amount: 18 ,unit:'pc', img:"https://www.vegrecipesofindia.com/wp-content/uploads/2022/10/gulab-jamun-recipe-01.jpg"},
          {name:"Kala Jamun", price:'₹25/pc',amount: 25 ,unit:'pc', img:"https://www.cookwithmanali.com/wp-content/uploads/2020/10/Kala-Jamun-500x500.jpg"},
          {name:"Rasgulla", price:'₹18/pc',amount: 18 ,unit:'pc', img:"https://prashantcorner.com/cdn/shop/products/RASGULLA_2457ea2c-400a-4130-b540-b77966e63d07.jpg?v=1673073151&width=1946"},
          {name:"Chamcham", price:'₹18/pc',amount: 18 ,unit:'pc', img:"https://cdn.ready-market.com.tw/21cd62de/Templates/pic/ANKO-Cham-Cham-1200x1200.jpg?v=4f1f0a97"},
          {name:"Rasbhari", price:'₹480/kg',amount: 480 ,unit:'kg', img:"https://www.govindam.co.in/wp-content/uploads/2025/01/Rasbhari-Sweet-3.webp"},
          {name:"Rasmalai", price:'₹40/pc',amount: 40 ,unit:'pc', img:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTQKRN8_L8bzbrsJNA3ksQpgMMD8ynTG6aUnQ&s"},
          {name:"Angoorie Rasmalai", price:'₹650/kg',amount: 650 ,unit:'kg', img:"/images/Catering/desserts/angoori-rasmalai.jpg"},
          {name:"Puran Poli", price:'₹70/pc',amount: 70 ,unit:'pc', img:"/images/Catering/desserts/puran-poli.jpg"},
          {name:"Khoa Poli", price:'₹80/pc',amount: 80 ,unit:'pc', img:"https://cdn.dotpe.in/longtail/store-items/7916910/9P6QP42e.jpeg"},
          // {name:"Til Poli", price:'₹150/pc',amount: 150 ,unit:'kg', img:"https://www.recipesworld.co.uk/images/167335704149113316.webp"},
          {name:"Gajar Ka Halwa", price:'₹650/kg',amount: 650 ,unit:'kg', img:"https://www.whiskaffair.com/wp-content/uploads/2019/05/Gajar-Ka-Halwa-2-3.jpg"},
          // {name:"Lauki Ka Halwa", price:'₹150/pc',amount: 150 ,unit:'pc', img:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvNhRjiByE7EtuOPNAwDrfnHaCkUJ5NOCHwg&s"},
          {name:"Kapoor Kand", price:'₹450/kg',amount: 450 ,unit:'kg', img:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvNhRjiByE7EtuOPNAwDrfnHaCkUJ5NOCHwg&s"},
          {name:"Moong Daal Halwa", price:'580/kg',amount: 580 ,unit:'kg', img:"https://www.mygingergarlickitchen.com/wp-content/rich-markup-images/1x1/1x1-rajasthani-moong-dal-halwa.jpg"},
          {name:"Basundi", price:'₹550/kg',amount: 550 ,unit:'kg', img:"https://www.cookingcarnival.com/wp-content/uploads/2023/03/Basundi-4.jpg"},
          {name:"Any Type of Kheer", price:'₹550/kg',amount: 550 ,unit:'kg', img:"https://www.indianveggiedelight.com/wp-content/uploads/2017/08/rice-kheer-instant-pot-featured-image.jpg"},
          {name:"Shahi Tukda", price:'₹500/kg',amount: 500 ,unit:'kg', img:"https://www.whiskaffair.com/wp-content/uploads/2019/03/Shahi-Tukda-2-3.jpg"},
          {name:"Jalebi", price:'₹250/kg',amount: 250 ,unit:'kg', img:"https://s3-ap-south-1.amazonaws.com/betterbutterbucket-silver/shubhi-mishra20171004002157988.jpeg"},
          {name:"Rabadi", price:'₹680/kg',amount: 680 ,unit:'kg', img:"https://s3-ap-south-1.amazonaws.com/betterbutterbucket-silver/renu-chandratre2018032020403041.jpeg"},
          // {name:"Ice Cream", price:'₹450/kg',amount: 150 ,unit:'kg', img:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT6HhedQdurLUbPn70JFdb0jldFgv7dZQnYBw&s"},
          {name:"Shree khand", price:'₹280/kg',amount: 280 ,unit:'kg', img:"https://www.indianveggiedelight.com/wp-content/uploads/2023/03/shrikhand-featured.jpg"},
          {name:"Amrakhand", price:'₹300/kg',amount: 300 ,unit:'kg', img:"https://ghodkesweets.com/wp-content/uploads/2020/10/amrakhand@2x.jpg"},
          // {name:"Fruit Custard", price:'₹450/kg',amount: 150 ,unit:'kg', img:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQSqTmswFi3QeHHPSPwF2XVWiyhJiNGYeserQ&s"},
          // {name:"Mousse", price:'₹450/kg',amount: 150 ,unit:'kg', img:"https://fullofplants.com/wp-content/uploads/2018/04/light-and-fluffy-aquafaba-strawberry-mousse-vegan-gluten-free-thumb-10.jpg"},
          // {name:"Cheese Cake", price:'₹450/kg',amount: 150 ,unit:'kg', img:"https://preppykitchen.com/wp-content/uploads/2022/07/cheesecake-blog-2.jpg"},
          // {name:"Fruit Tart", price:'₹450/kg',amount: 150 ,unit:'kg', img:"https://richanddelish.com/wp-content/uploads/2023/05/mini-fruit-tarts-2.jpg"}
   ]
    },
    {   name:"Savouries",
        value: [
          {name:"Plain Curd", price:'₹100/kg',amount: 100 ,unit: 'kg', img:"https://enjoyinfourseason.com/wp-content/uploads/2022/05/Fourseason-PLAIN-CURD.jpg"}, 
            {name:"Mattha", price:'₹100/kg',amount: 100 ,unit: 'kg', img:"https://miro.medium.com/v2/resize:fit:10156/1*JiIaw8B_bRZG_eKXo059QA.jpeg"}, 
            {name:"Kadhi", price:'₹200/kg',amount: 200 ,unit: 'kg', img:"https://www.livingsmartandhealthy.com/wp-content/uploads/2024/06/Hyderabadi-Kadhi-Pakora2.jpg"},
          {name:"Pakoda (Moong / Onion / Mix)", price:'₹250/kg',amount: 250 ,unit: 'kg', img:"https://www.whiskaffair.com/wp-content/uploads/2020/07/Moong-Dal-Pakoda-2-3.jpg"}, 
            {name:"Dahi Wada", price:'₹400/kg',amount: 400 ,unit: 'kg', img:"https://sublimerecipes.com/wp-content/uploads/2021/04/DahiVada-FI-500x500.jpg"}, 
            {name:"Dahi Bhalla", price:'₹500/kg',amount: 500 ,unit: 'kg', img:"https://www.prabhatkhabar.com/wp-content/uploads/2025/07/%E0%A4%B8%E0%A4%BE%E0%A4%B5%E0%A4%A8-%E0%A4%AE%E0%A5%87%E0%A4%82-%E0%A4%95%E0%A5%8D%E0%A4%AF%E0%A5%8B%E0%A4%82-%E0%A4%A8%E0%A4%B9%E0%A5%80%E0%A4%82-%E0%A4%96%E0%A4%BE%E0%A4%A4%E0%A5%87-%E0%A4%A8%E0%A5%89%E0%A4%A8%E0%A4%B5%E0%A5%87%E0%A4%9C-5.jpg"},
          {name:"Sandwich Dhokla", price:'₹400/kg',amount: 400 ,unit: 'kg', img:"https://dhoklahouse.com/wp-content/uploads/2025/04/dhokla-house-sandwich-dhokla-03.jpg"}, 
            {name:"White Dhokla", price:'₹450/kg',amount: 450 ,unit: 'kg', img:"https://static.toiimg.com/photo/59190882.cms"}, 
            {name:"Cutlet", price:'₹450/kg',amount: 450 ,unit: 'kg', img:"https://www.whiskaffair.com/wp-content/uploads/2020/09/Veg-Cutlet-2-3.jpg"},
          {name:"BatataWada", price:'₹400/kg',amount: 400 ,unit: 'kg', img:"https://www.indianhealthyrecipes.com/wp-content/uploads/2022/04/batata-vada-recipe.jpg"}, 
            {name:"DaalWada", price:'₹450/kg',amount: 450 ,unit: 'kg', img:"https://www.cookingcarnival.com/wp-content/uploads/2022/07/Dal-Vada-7.jpg"}, 
            {name:"Khandvi", price:'₹550/kg',amount: 550 ,unit: 'kg', img:"https://s3-ap-south-1.amazonaws.com/betterbutterbucket-silver/disha-khurana14596966695701341ce8e8a.jpeg"},
          {name:"Sambar Wadi (seasonal)", price:'₹400/kg',amount: 400 ,unit: 'kg', img:"https://www.puvi.co/uploaded_images/1687243291.jpg"}, 
            {name:"Green Peas Kachori", price:'₹450/kg',amount: 450 ,unit: 'kg', img:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSiD8ch-IdH-cZft0CUeae6vbJzBlmC7ZRldw&s"}, 
            {name:"Mix Veg Mini Samosa", price:'₹450/kg',amount: 450 ,unit: 'kg', img:"https://pataks.ca/wp-content/uploads/2022/05/homemade-vegetable-samosas.jpg"},
          {name:"Boondie Raita", price:'₹300/kg',amount: 300 ,unit: 'kg', img:"/images/Catering/savouries/boondi-raita.jpg"}, 
            {name:"Pineapple / Mix Fruit Raita", price:'₹450/kg',amount: 450 ,unit: 'kg', img:"https://www.tipsnrecipesblog.com/wp-content/uploads/2025/04/fruit-raita-main.jpg"}, 
            ]
    },
    {   name:"Salads",
        value: [{name:"Green Salad", price:'₹150/kg',amount: 150,unit: 'kg', img:"https://leelalicious.com/wp-content/uploads/2018/08/Corn-Tomato-Avocado-Salad-Recipe-500x500.jpg"}, 
            {name:"Sprouts Salad",price:'₹200/kg',amount: 200,unit: 'kg', img:"https://www.whiskaffair.com/wp-content/uploads/2020/04/Sprouts-Salad-3.jpg"}, 
            {name:"Chick Peas Salad",price:'₹200/kg',amount: 200,unit: 'kg', img:"https://www.lisashealthykitchen.com/wp-content/uploads/chickpea-feta-cucumber-tomato-salad-recipe.jpg"}, 
            {name:"Mix / Kakdi Koshimbir",price:'₹200/kg',amount: 200,unit: 'kg', img:"https://ministryofcurry.com/wp-content/uploads/2020/06/koshimbir_-4-500x500.jpg"}, 
            {name:"Russian Salad",price:'₹300/kg',amount: 300,unit: 'kg', img:"https://soupchick.s3.amazonaws.com/wp-content/uploads/2023/12/07140219/SALAD0030_1.png"}, 
            {name:"Mexican Salad",price:'₹300/kg',amount: 300,unit: 'kg', img:"https://veganheaven.org/wp-content/uploads/2020/05/Mexican-Salad-9.jpg"}, 
            {name:"Cheese Macaroni Salad",price:'₹300/kg',amount: 300,unit: 'kg', img:"https://www.eatingonadime.com/wp-content/uploads/2023/01/EasyMacaroniSalad-Square-Pic.jpg"}, 
            {name:"Corn Potato Salad",price:'₹250/kg',amount: 250,unit: 'kg', img:"https://www.peanutblossom.com/wp-content/uploads/2015/06/frenchpotatosalad-17.jpg"}]
    }, 
    ]
    ...
    const handleSelectedOptions = (category, itemName, price) => {
    setSelectedOptions(prev => {
    ...
    if (alreadySelected) {
      ...
      // ❌ REMOVE from bulkItems
      setBulkItems(prevBulk =>
        prevBulk.filter(bulk => bulk.item !== itemName)
      );
      ...
      // ➕ ADD to bulkItems (avoid duplicates)
      setBulkItems(prevBulk => {
        const exists = prevBulk?.some(bulk => bulk.item === itemName);
        if (exists) return prevBulk;

        return [
          ...prevBulk,
          { item: itemName, price, qty: 0 }
        ];
      });
    }
  ...
  return (
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-1 md:gap-2 p-1 md:p-4 ">
        {activeSnack?.value.map((snackItem, index) => (
          <div key={index} className="bg-white rounded-2xl py-2 px-1 shadow-md flex flex-col items-center  justify-between">
            ...
            <div className='group'>
            <button onClick={ ()=> handleSelectedOptions(isActive, snackItem.name, snackItem.amount )}>
    ...
    <CustomizeBarBulk selectedOptions={selectedOptions} setSelectedOptions={setSelectedOptions}/>
      </div>
      ) : (
