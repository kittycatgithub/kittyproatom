      ...
      <path d="M18.3711 31.587V36.4343L30.4893 45.5229V29.7693L27.0962 27.2245C23.4971 24.5282 18.3711 27.0912 18.3711 31.587Z" fill="#C5221F"/>
                ...
                <div className="mx-auto text-center sm:text-left">
                    ...
                    <ul className="text-sm lg:text-md font-semibold   transition-all duration-500">
                        <li className="mb-6"><a href="/"  className="text-gray-800 hover:text-gray-900">Home</a></li>
                        <li className="mb-6"><a href="/about"  className="text-gray-800 hover:text-gray-900">About</a></li>
