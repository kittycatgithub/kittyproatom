  ...
  return (
        ...
        <div className="mx-auto max-w-7xl lg:px-8 pt-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-4 gap-0 lg:gap-0 max-w-xs mx-auto sm:max-w-2xl md:max-w-3xl lg:max-w-full">
                <div className="col-span-full lg:col-span-1 mb-10 lg:mb-0">
                    ...
                    <p className="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">Trusted by more than 100 companies & 5 million customers. Follow us on social media.</p>
      ...
      <path d="M18.3711 31.587V36.4343L30.4893 45.5229V29.7693L27.0962 27.2245C23.4971 24.5282 18.3711 27.0912 18.3711 31.587Z" fill="#C5221F"/>
                ...
                <div className="mx-auto text-center sm:text-left">
                    ...
                    <ul className="text-sm lg:text-md font-semibold   transition-all duration-500">
                        <li className="mb-6"><a href="javascript:;"  className="text-gray-600 hover:text-gray-900">Home</a></li>
                        <li className="mb-6"><a href="javascript:;"  className=" text-gray-600 hover:text-gray-900">Services</a></li>
                        <li className="mb-6"><a href="javascript:;"  className=" text-gray-600 hover:text-gray-900">My Orders</a></li>
                        <li className=""><a href="javascript:;"  className=" text-gray-600 hover:text-gray-900">Contact</a></li>
                   </ul>
                </div>
                {/* <!--End Col--> */}
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-5">
            ...
            <hr className='border-t border-gray-200'/>
                    ...
                    <ul className="text-sm  transition-all duration-500">
                        ...
                        <li className="mb-6"><a href="javascript:;"  className=" text-gray-600 hover:text-gray-900">BARON INTEGRATED SERVICES PVT. LTD</a></li>
                        <li><a href="javascript:;"  className=" text-gray-600 hover:text-gray-900">44, Chandra Nagar, Near Omkar Nagar Square<br/>Manewada, Nagpur, Maharashtra - 440027</a></li>
                    </ul>
                </div>    
            </div>
            {/* <!--Grid--> */}
            <div className="py-7 border-t border-gray-200">
                <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                    <span className="text-sm text-gray-500 ">©<a href="https://pagedone.io/">Baron Kitchen</a>2025, All rights reserved.</span>
                    <span className="text-sm text-gray-500 pt-4"><a href="https://pagedone.io/">Designed & Developed By HostCloudRCS</a></span>
