...
const Navbar = () => {
    ...
    const {user, setUser, setShowUserLogin, navigate, setSearchQuery, searchQuery, getCartCount, cart} = useAppContext()
  ...
  return (
    <nav className=" flex items-center justify-between z-35 px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <h1 className='text-xl font-semibold text-gray-600 lg:hidden'>Baron Kitchen</h1>
                <img className="h-9 hidden" src="https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/dummyLogo/dummyLogoColored.svg" alt="dummyLogoColored" />
            </NavLink>
