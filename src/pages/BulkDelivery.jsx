...
<div className='grid md:grid-cols-2 items-start  mx-auto max-w-5xl'>
   ...
   <div className=" flex items-center justify-center p-4 md:p-8 font-sans antialiased text-gray-900">
      <div className="w-full max-w-md bg-white rounded-2xl shadow overflow-hidden transition-all duration-300 transform hover:shadow-xl hover:-translate-y-1">
        ...
        {/* Product Details */}
        <div className="p-6">
          <div className="text-indigo-600 text-xl font-semibold uppercase tracking-wide mb-2">{product3.title}</div>
          {/* <h2 className="text-xl text-gray-900 leading-tight mb-1 px-1">{product3.title}</h2> */}
  ...
  <div className=" flex items-center justify-center p-4 md:p-8 font-sans antialiased text-gray-900">
      <div className="w-full max-w-md bg-white rounded-2xl shadow overflow-hidden transition-all duration-300 transform hover:shadow-xl hover:-translate-y-1">
        ...
        {/* Product Details */}
        <div className="p-6">
          <div className="text-indigo-600 text-xl font-semibold uppercase tracking-wide mb-2">{product4.title}</div>
